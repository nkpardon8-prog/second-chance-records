...
export type ShopSwagItem = typeof schema.shopSwagItems.$inferSelect;
export type ShopSwagImage = typeof schema.shopSwagImages.$inferSelect;
export type ShopSwagItemWithImages = ShopSwagItem & { images: ShopSwagImage[] };
